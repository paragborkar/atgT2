...
const Home = () => {
  ...
  return (
    <>
      ...
      <div
        className="main-container d-flex bg-dark"
        style={{ height: "90vh" }}
      >
        {loading ? (
          <div
          ...
          <div className="users-container col-8 col-xl-6 mx-auto my-4 d-flex flex-column  gap-4  overflow-y-scroll">
            {users.map((user, i) => (
              <div
                ...
                style={{ cursor: "pointer", backgroundColor: "#111111" }}
        ...
        <div
          className="current-user-container col-4 col-xl-4 flex-column text-white card2"
          style={{
